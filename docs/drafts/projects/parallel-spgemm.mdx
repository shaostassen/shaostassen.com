...
tags: [Parallel computing, Sparse linear algebra, Performance engineering, C++, OpenMP]
timeframe: "Spring 2026" #
role: "solo" 
org: "Cornell ECE 6750" # 
repo: "private repo" 
featured: true
metrics:
...
- Target: a 32-core Xeon cluster.  single 32-core node (shared memory) 
...
~21× speedup over the serial implementation on 32 cores. 


### 
This is one of the many interesting projects I did in ECE 6750 - Advanced Computer Architercture - make a collection of these under one tab

      ...
      <Container>
        ...
        <div className="mt-10 grid gap-10 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8 lg:order-1">
            <Prose>
              <p>
                I&apos;m Shao — an engineer who likes the layer where software
                has to answer to physics. I studied electrical and computer
                engineering at Cornell (Class of 2026), where my favorite work
                involved making real hardware do difficult things: a
                differential-drive robot that Kalman-filters its way past its
                own sensor latency, the autonomous side of a 3&nbsp;lb combat
                robot — I led the autonomy subteam at Cornell Combat Robotics —
                and a sparse-matrix kernel pushed to ~21× speedup on 32 cores.
              </p>
              <p>
                From Fall 2024 through Spring 2026 I was an undergraduate
                researcher in Cornell&apos;s EmPRISE Lab, working on
        ...
        <Annotation className="mt-16">experience</Annotation>
        <h2 className="mt-4 font-display text-title">Experience</h2>
        <Timeline
          className="mt-6"
        ...
        <Annotation className="mt-16">education</Annotation>
        <h2 className="mt-4 font-display text-title">Education</h2>
        <Timeline
          className="mt-6"
